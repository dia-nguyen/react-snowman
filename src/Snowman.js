...
function Snowman({
  ...
  return (
    <div className="Snowman">
      <img
        src={nWrong > maxWrong ? images[maxWrong] : images[nWrong]}
        alt={nWrong > maxWrong ? maxWrong : nWrong}
      />
      ...
      {nWrong > maxWrong && (
        <p className="Snowman-lose-msg">
          You lose! The correct word was {answer}.
        </p>
      )}
      <button className="Snowman-restart" onClick={handleRestart}>
        Restart
      </button>
    </div>
  );
